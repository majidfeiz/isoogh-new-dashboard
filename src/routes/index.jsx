...
import PermissionEdit from "../pages/Permissions/PermissionEdit.jsx";

//roles

import RoleList from "../pages/Roles/RoleList.jsx";
import RoleForm from "../pages/Roles/RoleForm.jsx";
import RolePermissions from "../pages/Roles/RolePermissions.jsx";
...
import AdviserStudents from "../pages/Advisers/AdviserStudents.jsx";
...
const authProtectedRoutes = [
  ...
  { path: "/permissions/:id/edit", component: <PermissionEdit /> },

  // Role List
  { path: "/roles", component: <RoleList /> },
  { path: "/roles/create", component: <RoleForm /> },
  { path: "/roles/:id/edit", component: <RoleForm /> },
  { path: "/roles/:id/permissions", component: <RolePermissions /> },
  ...
  { path: "/advisers/:adviserId/students", component: <AdviserStudents /> },
